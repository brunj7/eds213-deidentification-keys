...
```{r}
writeSafeFile(obj=sdcInitial, format="csv", randomizeRecords="no", col.names=TRUE, sep=",", dec=".", fileOut="south-park-anon.csv")

#Please be aware that there is currently a glitch causing the column names in the output file to be offset by one. Also, remember that we intentionally kept the student IDs? Why? Because this allows us to link responses for research purposes, as long as the data is safeguarded. However, prior to sharing the dataset publicly, we'd have to ensure that you remove this direct identifier to protect the students' privacy.
```
